...
class TestComponent(unittest.TestCase):
    def setUp(self):
        self.mock_component = Component('mock_component', 'mock component 2', 'shreya', ['mock_tag'])
        
        self.mock_component_dict = {
            'name': self.mock_component.name, 'description': self.mock_component.description, 'owner': self.mock_component.owner, 'tags': self.mock_component.tags
        }
...
class TestComponentRun(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_component_run_dict = {'component_name': 'mock_component_run', 'inputs': [], 'outputs': [], 'git_hash': None, 'code_snapshot': None, 'start_timestamp': None, 'end_timestamp': None, 'dependencies': [], 'id': None}
    ...
    def testSerialize(self):
        ...
        Test the serialization functionality.
        """
        self.assertEqual(self.mock_component_run.to_dictionary(), self.mock_component_run_dict)
