...
The two prominent client-facing abstractions are the :automodule: `mltrace.entities.component` and :automodule: `mltrace.entities.component\_run` abstractions.
